...
Each session flows through 4 timed phases automatically:
...
- Visual soroban bead displays
- Works on Windows, Mac, and Linux in any modern browser

## Privacy

Zero data collection. All data stays in your browser's localStorage. No accounts, no analytics, no cookies, no network requests after loading.
